...
def london_schools_aq():
  ...
  print("")
  inputoption1 = input("What do you want to analyze? (case sensitive) ")
  print("")
  for key in startpage:
  ...
  if inputoption1 == "A":
    ...
    for key in cities:
      if inputoption2 in cities:
        print("")
        print("You have chosen: %s.%s" %(inputoption2, cities[inputoption2]))
        print("")
    ...
    for key in schooltypes:
      if inputoption3 in schooltypes:
        print("")
        print("You have chosen: %s" %inputoption3)
